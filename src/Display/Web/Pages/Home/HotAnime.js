...
import Placeholder from "./../components/Placeholders/PlaceholderCard";
import { Link } from "react-router-dom";

class HotAnime extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      anime: [],
          ...
          <div>
            <CardGroup itemsPerRow={6}>
              {!this.state.loading
                ...
                : [0, 1, 2, 3, 4, 5].map((e, i) => <Placeholder />)}
            </CardGroup>
          </div>
        </Card.Body>
      </Card>
